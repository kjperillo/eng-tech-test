# Description: Terraform module to create a Lambda function that will echo the contents of a file uploaded to an S3 bucket
...
# Update bucket policy to allow Lambda function to access bucket
